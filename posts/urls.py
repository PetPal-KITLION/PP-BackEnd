...
from .views import BoardPostCreateView, BoardPostBaseViewSet, BoardPostUpdateView, BoardPostDestroyView
...
urlpatterns = [
    ...
    path('board/<int:pk>/', BoardPostBaseViewSet.as_view({'get':'retrieve','post': 'create_comment'}), name='board-detail'),
